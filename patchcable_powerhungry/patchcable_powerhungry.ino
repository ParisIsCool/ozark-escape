...
const int signalPins[numSockets] = {23,22,21,19,18,5,17,16,4,0};

const int numConnections = 5;

//const int ledPins[numConnections] = {12,14,27,26,33};

const int connections[numConnections][2] = {{23,22},{21,19},{18,5},{17,16},{4,0}};
